...
const DesktopWidget: React.FC<DesktopWidgetProps> = ({
    ...
    const getStyleClasses = () => {
        ...
        switch (style) {
            ...
            case "neumorphic":
                return `${isDark ? "bg-[#1a1a1a] shadow-[5px_5px_10px_#0b0b0b,-5px_-5px_10px_#292929] text-gray-200" : "bg-[#e0e0e0] shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff] text-gray-700"} p-6 rounded-2xl`;
            default:
                return `font-sans ${baseText} drop-shadow-lg`;
        }
    };
