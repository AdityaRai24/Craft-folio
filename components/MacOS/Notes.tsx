...
import { Edit2, Folder, FileText, Search } from "lucide-react";
...
import { defaultMacOSNotesStyles } from "@/types/macos/notes";
...
const Notes = ({ theme = "light", portfolioId, font }: { theme?: "light" | "dark"; portfolioId?: string; font?: string }) => {
    ...
    } = useCustomization("notes", defaultMacOSNotesStyles, portfolioId || "");
