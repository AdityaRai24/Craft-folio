    ...
    const TechnologyCard = ({ tech }: { tech: Technology }) => (
        <motion.div
            ...
            style={{
                ...
                backgroundColor: isDark ? "rgba(32, 32, 32, 0.4)" : "rgba(255, 255, 255, 0.6)",
            ...
            <div className={`mx-auto p-8 max-w-${effectiveCustomization.containerWidth}`}>
                ...
                {effectiveCustomization.layout === "marquee" ? (
                    <div className="relative">
                        <div className={`absolute left-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-r ${isDark ? "from-[#202020]" : "from-[#f3f3f3]"} to-transparent`} />
                        <div className={`absolute right-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-l ${isDark ? "from-[#202020]" : "from-[#f3f3f3]"} to-transparent`} />
                        <Marquee
                            gradient={false}
